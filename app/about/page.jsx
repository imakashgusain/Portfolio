      ...
      <div className="w-full space-y-12 py-7">
        <div>
          ...
          <ul className=" space-y-2 text-lg leading-relaxed mb-4">
            <li>
              B.Tech in Computer Science, Dev Bhoomi Institute of Technology
              (2018-2022)
            </li>
        ...
        <div className="py-7">
          ...
          <ul className=" space-y-2 text-lg leading-relaxed mb-4">
            <li>
              <b>Senior Software Engineer at Gemini Solutions</b> (2021 -
              Present)
            </li>
            <li>
              Developed core features using Java, Spring Boot, and collaborated
              with teams to deliver solutions.
            </li>
          </ul>
        </div>
