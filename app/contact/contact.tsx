...
const Contact = () => {
  return (
    <div
      id="contact"
      className="min-h-screen flex flex-col justify-center items-center bg-gray-900 text-gray-100 px-8 py-1"
    >
      <div className="flex-grow flex flex-col justify-center items-center space-y-8">
        ...
        <p className="text-lg text-center leading-relaxed max-w-lg">
          I&apos;m open to freelance projects, collaboration, and exciting
